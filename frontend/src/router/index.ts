...
export default createRouter({
  ...
  routes: [
    ...
    { path: '/career-target', component: () => import('@/pages/CareerTargetPage.vue'), meta: { title: '目标岗位与 JD', eyebrow: '用真实招聘要求校准学习终点和能力差距' } },
    ...
    { path: '/settings', component: () => import('@/pages/SettingsPage.vue'), meta: { title: '个人设置', eyebrow: '账户、安全与外部服务' } },
